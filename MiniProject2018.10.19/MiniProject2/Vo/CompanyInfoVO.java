...
public class CompanyInfoVO {
	 ...
	 * 모집시기 시작일
	 */
	private Date c_recruitment_start;
	/**
	 * 모집시기 종료일
	 */
	private Date c_recruitment_end;
	/**
	 * 지원자격 및 우대사항
	 */
	...
	public CompanyInfoVO(String c_name, String c_field, String c_intro, Date c_recruitment_start,
			Date c_recruitment_end, String c_qualification, String c_area, String c_talent) {
		this.c_name = c_name;
	...
	public Date getC_recruitment_start() {
		return c_recruitment_start;
	}

	public void setC_recruitment_start(Date c_recruitment_start) {
		this.c_recruitment_start = c_recruitment_start;
	}

	public Date getC_recruitment_end() {
		return c_recruitment_end;
	}

	public void setC_recruitment_end(Date c_recruitment_end) {
		this.c_recruitment_end = c_recruitment_end;
	}
	...
	public String toString() {
		return "CompanyInfoVO [c_name=" + c_name + ", c_field=" + c_field + ", c_intro=" + c_intro
